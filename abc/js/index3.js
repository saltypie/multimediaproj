...
document.addEventListener('DOMContentLoaded', function () {
  const content = [
    ...
    { title: "Subtropical Climate: Foodways and Longevity", text: `
              ...
              <figure>
                <img src='https://p.potaufeu.asahi.com/b952-p/picture/27584576/03c7fde06199bf7fdfe7aab101bfd20f.jpg' alt='Okinawan Dish' style='width:100%; margin-top:10px;'>
              ...
              <figure>
                <img src="https://blackgirlseat.com/wp-content/uploads/2022/03/Untitled-design-3-1024x1024.png" alt="Purple Sweet Potatoes" style="width:100%; margin-top:10px;">
              ...
              <figure>
                <img src="https://www.justonecookbook.com/wp-content/uploads/2024/04/Goya-Champuru-2682-I.jpg" alt="Goya Champuru" style="width:100%; margin-top:10px;">
              ...
              <figure>
                <img src="https://i.natgeofe.com/n/0d7b6a61-ccee-46c6-9bfa-3ba4b73084cb/41553.jpg" alt="Okinawan Longevity" style="width:100%; margin-top:10px;">
    ...
    { title: "Architecture and Planning: Built for Typhoons", text: `
              ...
              <figure>
                <img src="https://amakuma.ryukyu/wp-content/uploads/2023/04/culture_hinpun-1-1024x683.jpg" alt="Hinpun Screen" style="width:100%; margin-top:10px;">
              ...
              <figure>
                <img src="https://thumb.photo-ac.com/b1/b1f32100f584efbe22ca864b42e13c9e_t.jpeg" alt="Red Tiled Roofs" style="width:100%; margin-top:10px;">
    ...
    { title: "Flora: Okinawan Blossoms and Biodiversity", text: `
              ...
              <figure>
                <img src="https://static.gltjp.com/glt/data/directory/16000/15394/20240124_123822_9bb3429b_w1920.webp" alt="Fukugi Tree" style="width:100%; margin-top:10px;">
              ...
              <figure>
                <img src="https://www.taiwan-panorama.com/Image/Resize/V1/Uploads/2025/02/fab862a9-784d-43b2-8868-e852c6c0b712/4-1.JPG?w=1080&mode=crop&format=webp&quality=80" alt="Shell Ginger" style="width:100%; margin-top:10px;">
    ...
    { title: "Fauna: Island Wildlife and Identity", text: `
              ...
              <figure>
                <img src="https://upload.wikimedia.org/wikipedia/commons/7/79/Okinawa_Rail_imported_from_iNaturalist_photo_388492786_on_12_June_2024.jpg" alt="Okinawa Rail" style="width:100%; margin-top:10px;">
              ...
              <figure>
                <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/a/ad/Amphiprion_ocellaris_%28Clown_anemonefish%29_by_Nick_Hobgood.jpg/1200px-Amphiprion_ocellaris_%28Clown_anemonefish%29_by_Nick_Hobgood.jpg" alt="Clownfish" style="width:100%; margin-top:10px;">

// Falling leaves/flowers animation for index4 (Snake Skin Strings)
...
function createLeaf() {
    ...
    document.querySelector('.snake-skin-page #falling-leaves').appendChild(leaf);
...
function createFlower() {
    ...
    document.querySelector('.snake-skin-page #falling-leaves').appendChild(flower);

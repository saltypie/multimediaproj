// Falling leaves/flowers animation for index5-5 (Okinawan History)
...
function createLeaf() {
    ...
    document.querySelector('.okinawa-history-page #falling-leaves').appendChild(leaf);
...
function createFlower() {
    ...
    document.querySelector('.okinawa-history-page #falling-leaves').appendChild(flower);
